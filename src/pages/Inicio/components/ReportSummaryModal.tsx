...
export default function ReportSummaryModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-xl rounded-2xl border border-zentinel-gold/30 bg-zentinel-dark-secondary p-6 shadow-2xl" style={{boxShadow: '0 20px 60px rgba(0,0,0,0.3), 0 0 0 1px color-mix(in srgb, var(--color-zentinel-gold) 20%, transparent)'}}>
        <h3 className="text-2xl font-bold text-zentinel-text">Resumen del reporte</h3>
